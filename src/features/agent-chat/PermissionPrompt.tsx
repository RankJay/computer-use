...
function permissionSummaryLooksLikeCommand(summary: string): boolean {
...
export function PermissionPrompt(props: PermissionPromptProps): ReactElement {
  const summaryIsCommand = permissionSummaryLooksLikeCommand(props.pending.summary);

  return (
    <section
      className="flex max-h-[min(50dvh,22rem)] flex-col overflow-hidden rounded-2xl border border-amber-900/40 bg-[#141414] shadow-[0_8px_32px_rgba(0,0,0,0.45)]"
    ...
    >
          ...
          <div className="min-w-0 flex-1 space-y-2">
            ...
            {summaryIsCommand ? (
              <pre
                ...
                className="wrap-break-word rounded-lg border border-neutral-800 bg-[#0c0c0c] px-3 py-2 font-mono text-[11px] leading-relaxed whitespace-pre-wrap text-neutral-300"
              >
      ...
      <div className="shrink-0 border-t border-neutral-800/80 bg-[#141414] p-4 pt-3">

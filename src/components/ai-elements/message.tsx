  ...
  ({ className, ...props }: MessageResponseProps) => (
    <Streamdown
      className={cn(
        ...
        "**:data-[streamdown=heading-1]:text-2xl **:data-[streamdown=heading-1]:font-[450] **:data-[streamdown=heading-1]:tracking-tight",
        "**:data-[streamdown=heading-2]:text-xl **:data-[streamdown=heading-2]:font-[450] **:data-[streamdown=heading-2]:tracking-tight",
        "**:data-[streamdown=heading-3]:text-lg **:data-[streamdown=heading-3]:font-[450] **:data-[streamdown=heading-3]:tracking-tight",
        "**:data-[streamdown=heading-4]:text-base **:data-[streamdown=heading-4]:font-[450] **:data-[streamdown=heading-4]:tracking-tight",
